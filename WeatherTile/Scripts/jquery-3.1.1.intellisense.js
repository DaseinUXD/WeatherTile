intellisense.annotate(jQuery, {
  'ajax': function() {
    ...
    ///   <param name="settings" type="PlainObject">A set of key/value pairs that 
    ///   the Ajax request.All settings are optional.A default can be set for any option with $.ajaxSetup().See jQuery.ajax(settings) below for a complete list of all settings.</param>
    ///   <returns type="jqXHR" />
    /// </signature>
    /// <signature>
    ///   <summary>Perform an asynchronous HTTP (Ajax) request.</summary>
